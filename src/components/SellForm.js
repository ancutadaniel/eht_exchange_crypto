...
export const SellForm = ({ ethBalance, dacetherBalance, sellDacether }) => {
  const ref = useRef("");
  ...
  return (
    <form
      ...
      onSubmit={(e) => {
        e.preventDefault();
        let dacetherAmount = ref.current.value.toString();
        dacetherAmount = window.web3.utils.toWei(dacetherAmount, "Ether");
    ...
    >
      ...
      <div className="mb-5">
        ...
        <span className="float-right text-muted">100 Dacether = 1 EHT</span>
      </div>
